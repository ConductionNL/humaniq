 ...
 *
 * @spec exclude vendored test-only copy of OpenRegister lib/Service/Dmn (source: openregister@d1594ccd, flow-decision-tables); loaded by tests/bootstrap.php only when the real class is absent
 */
