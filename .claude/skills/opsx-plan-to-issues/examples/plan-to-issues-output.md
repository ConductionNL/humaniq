...
Default branch: `main` — but `development` exists, preferring it per Hydra convention.
...
Base branch: `development`
Feature branch (resolved after issue is created): `feature/<N>/add-webhook-support`
...
### Resolving feature branch and updating issue body...

Feature branch: `feature/142/add-webhook-support`

```
gh issue edit 142 --repo ConductionNL/openregister --body "..."
```

✓ Updated issue #142 — `## Branch` section now resolved.
...
```json
{
  ...
  "feature_branch": "feature/142/add-webhook-support",
  "created": "2026-04-10",
  "tracking_issue": 142,
  "tasks": [...]
}
...
- Labels: openspec, openregister, webhooks
- Base branch: `development` → Feature branch: `feature/142/add-webhook-support`
