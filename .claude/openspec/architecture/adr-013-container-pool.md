...
| Image | Size | Purpose |
|-------|------|---------|
| `ghcr.io/conductionnl/hydra-nextcloud-test:stable32` | 1.5GB | Prebuild NC server + PostgreSQL + OpenRegister (cloned) |
...
- Builder `COPY --from=ghcr.io/conductionnl/hydra-nextcloud-test:stable32` at build time
