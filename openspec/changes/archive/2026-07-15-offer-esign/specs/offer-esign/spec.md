...
**Kind:** code (service duck-typed pipeline + two occ commands + one guarded controller endpoint dominate; three additive schema fields, one seed, and one manifest action ride along — see design.md "Mixed-spec rationale")

**OpenSpec changes**
- `offer-esign` (2026-07-16)
