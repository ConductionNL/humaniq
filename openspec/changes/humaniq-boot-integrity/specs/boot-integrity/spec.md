...
Give humaniq a trustworthy measurement surface — a way to know that its installed dependencies match
...
2026-08-19 12:43, `js/humaniq-main.js` was last built 2026-07-30 16:25) — via a mechanism suitable for
...
- **GIVEN** `src/manifest.json`'s last-modified time is newer than `js/humaniq-main.js`'s
...
- **GIVEN** this checkout's current source (both humaniq's `App.vue` and the installed
