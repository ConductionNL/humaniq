...
| `framework`      | yes      | framework/law slug (e.g. `wtd-2003-88`, `eu-2019-1152`, `gdpr`, `bw7-10`, `wml`, `nl-pensioenaangifte`, `nl-poortwachter`, `nl-wid`, `hr-org-core`, `hr-assets-core`, `nl-arbeidstijdenwet`, `hr-signals`, `hr-administratie-core`, `hr21`, `ambtenarenwet-2017`, `wnt-2013`) |
