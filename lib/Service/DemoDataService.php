<?php
/**
 * Humaniq DemoDataService.
 *
 * Imports `lib/Settings/humaniq_mock_register.json` — a `type: mock` descriptor generated from this
...
class DemoDataService {
	 ...
	 * @var string
	 */
	private const DESCRIPTOR = '/lib/Settings/humaniq_mock_register.json';
